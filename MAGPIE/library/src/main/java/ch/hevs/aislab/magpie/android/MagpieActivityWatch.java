...
public abstract class MagpieActivityWatch extends FragmentActivity implements MagpieConnection {
    ...
    private static class ReplyHandler extends Handler {
        ...
        private WeakReference<MagpieActivityWatch> mActivity;

        ReplyHandler(MagpieActivityWatch activity) {
            mActivity = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message reply) {
            MagpieActivityWatch activity = mActivity.get();
            if (activity == null) {
                return;
            }
        ...
        private void processAlert(Message reply, MagpieActivityWatch activity) {
        ...
        private void sendContext(MagpieActivityWatch activity) {
