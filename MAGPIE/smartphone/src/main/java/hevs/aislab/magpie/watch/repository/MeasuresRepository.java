...
/**
 * this class will take car of the Measures CRUD access. Querry are made by the ORM. It's a singletone class
 */
...
public class MeasuresRepository {
    ...
    public void insertOrReplace(Measure measure)
    {
        measuresDao.insertOrReplace(measure);
    }
