...
//                if (path.equals(Const.PATH_PUSH_MEASURE)) {}
                ...
                Log.d("sizeofRuleDB=",RulesRepository.getInstance().getAll().size()+"");
    ...
    private CustomRules extractRulesFromDataMap(DataMap dataMap)
    {
        ...
        rule.setVal_1_min(dataMap.getDouble(Const.KEY_RULE_VAL1_MIN));
        rule.setVal_1_max(dataMap.getDouble(Const.KEY_RULE_VAL1_MAX));
        rule.setVal__2_min(dataMap.getDouble(Const.KEY_RULE_VAL2_MIN));
        rule.setVal_2_max(dataMap.getDouble(Const.KEY_RULE_VAL2_MAX));
